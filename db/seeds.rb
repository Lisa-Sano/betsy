...
products = [
  { name: "Flora Stone Maxi Dress", price: 35600, user_id: 1, description: "V-neck maxi in tropical print featuring adjustable spaghetti straps and center cutout with tie at bust", stock:20, photo_url: "https://s-media-cache-ak0.pinimg.com/736x/9f/dc/97/9fdc97ffb840b8fd044825ab096a40ec.jpg", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },

  { name: "Eyelet-Yoke Top", price: 4500, user_id: 1, description: "Sleeveless top in floral motif featuring crochet yoke and vertical insets at front and back", stock:20, photo_url: "http://assets.charmingshoppes.com/is/image/LaneBryant/pr_175047_1A?$product_main$&wid=354&hei=460", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },

  { name: "Tree of Life Pendant Necklace", price: 9130, user_id: 2, description: "Sterling silver necklace featuring polished pendant with gold-plated tree at center and diamond-studded leaves", stock:20, photo_url: "http://cdn-tp2.mozu.com/12282-17282/cms/17282/files/875fe66d-f433-4aa8-a94f-639df83c50f4?max=350", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },

  { name: "Bold Stainless Steel Bracelet Watch", price: 55000, user_id: 2, description: "Elegant brushed stainless steel watch featuring white sunray dial with signature dot at 12 o'clock", stock:20, photo_url: "https://www.passthewatch.com/media/catalog/product/cache/1/small_image/350x350/9df78eab33525d08d6e5fb8d27136e95/3/6/3600276_1.jpg", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },

  { name: "Cedar Street Bag", price: 28000, user_id: 3, description: "Colorful crocheted satchel featuring hardware feet and removable cross-body strap", stock:20, photo_url: "https://s-media-cache-ak0.pinimg.com/736x/29/8c/35/298c3550315e5146ec4b40ed2e324d55.jpg", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },

  { name: "Family Tree Personalized Names Necklace", price: 2900, user_id: 3, description: "Personalized family necklace with copper family tree charm in silver washer by DistinctlyIvy", stock:20, photo_url: "http://www.bodycandy.com/mas_assets/full/HC-3562.jpg", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },

  { name: "Ally Secret Trellis Long Silk Scarf", price: 15900 , user_id: 4, description: "Silk scarf in windowpane gingham with flowery ombre-tone border", stock:20, photo_url: "http://i00.i.aliimg.com/wsphoto/v7/619645742_1/2013-New-Arrival-Fashion-Satin-Big-Square-Scarf-Printed-For-Women-90-90cm-Ladies-s-Brand.jpg_350x350.jpg", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },

  { name: "Good Vibes Crinkle Wrap", price: 15900 , user_id: 4, description: "Lightweight orange scarf featuring delicate eyelash fringe and glittering ends", stock:20, photo_url: "http://s8.thisnext.com/media/largest_dimension/6B974A25.jpg", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000)},

  { name: "Carrson Dress Sandal", price: 90000 , user_id: 5, description: "Ankle-strap sandal in rich leather featuring covered block heel and single toe", stock:20, photo_url: "https://i.guim.co.uk/img/static/sys-images/Guardian/Pix/pictures/2012/1/18/1326907445081/Paula-Deen-riding-a-stick-007.jpg?w=620&q=55&auto=format&usm=12&fit=max&s=acddaa78287bd521cdfb7aa108d86c05", height: rand(1..10), width: rand(1..10), length: rand(1..10), weight: rand(100..2000) },
