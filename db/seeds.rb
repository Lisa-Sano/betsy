...
products = [
  { weight: 3, height: 6 , length:41,  width:21 , name: "Flora Stone Maxi Dress", price: 35600, user_id: 1, description: "V-neck maxi in tropical print featuring adjustable spaghetti straps and center cutout with tie at bust", stock:20, photo_url: "https://s-media-cache-ak0.pinimg.com/736x/9f/dc/97/9fdc97ffb840b8fd044825ab096a40ec.jpg"  },

  { weight: 2 , height:  7, length:2,  width: 21, name: "Eyelet-Yoke Top", price: 4500, user_id: 1, description: "Sleeveless top in floral motif featuring crochet yoke and vertical insets at front and back", stock:20, photo_url: "http://assets.charmingshoppes.com/is/image/LaneBryant/pr_175047_1A?$product_main$&wid=354&hei=460"  },

  { weight:  4, height:  30, length:32,  width: 22, name: "Tree of Life Pendant Necklace", price: 9130, user_id: 2, description: "Sterling silver necklace featuring polished pendant with gold-plated tree at center and diamond-studded leaves", stock:20, photo_url: "http://cdn-tp2.mozu.com/12282-17282/cms/17282/files/875fe66d-f433-4aa8-a94f-639df83c50f4?max=350"  },

  { weight: 2 , height:  12, length:12,  width: 12, name: "Bold Stainless Steel Bracelet Watch", price: 55000, user_id: 2, description: "Elegant brushed stainless steel watch featuring white sunray dial with signature dot at 12 o'clock", stock:20, photo_url: "https://www.passthewatch.com/media/catalog/product/cache/1/small_image/350x350/9df78eab33525d08d6e5fb8d27136e95/3/6/3600276_1.jpg"  },

  { weight: 1 , height:  23, length:22,  width: 12, name: "Cedar Street Bag", price: 28000, user_id: 3, description: "Colorful crocheted satchel featuring hardware feet and removable cross-body strap", stock:20, photo_url: "https://s-media-cache-ak0.pinimg.com/736x/29/8c/35/298c3550315e5146ec4b40ed2e324d55.jpg"  },

  { weight: 1.4 , height: 21 , length:22,  width:15 , name: "Family Tree Personalized Names Necklace", price: 2900, user_id: 3, description: "Personalized family necklace with copper family tree charm in silver washer by DistinctlyIvy", stock:20, photo_url: "http://www.bodycandy.com/mas_assets/full/HC-3562.jpg"  },

  { weight: 5 , height: 22 , length:10,  width: 15, name: "Ally Secret Trellis Long Silk Scarf", price: 15900 , user_id: 4, description: "Silk scarf in windowpane gingham with flowery ombre-tone border", stock:20, photo_url: "http://i00.i.aliimg.com/wsphoto/v7/619645742_1/2013-New-Arrival-Fashion-Satin-Big-Square-Scarf-Printed-For-Women-90-90cm-Ladies-s-Brand.jpg_350x350.jpg"  },

  { weight: 7 , height: 11 , length:12,  width: 15, name: "Good Vibes Crinkle Wrap", price: 15900 , user_id: 4, description: "Lightweight orange scarf featuring delicate eyelash fringe and glittering ends", stock:20, photo_url: "http://s8.thisnext.com/media/largest_dimension/6B974A25.jpg" },

  { weight: 3 , height:  22, length:14,  width: 6, name: "Carrson Dress Sandal", price: 90000 , user_id: 5, description: "Ankle-strap sandal in rich leather featuring covered block heel and single toe", stock:20, photo_url: "https://i.guim.co.uk/img/static/sys-images/Guardian/Pix/pictures/2012/1/18/1326907445081/Paula-Deen-riding-a-stick-007.jpg?w=620&q=55&auto=format&usm=12&fit=max&s=acddaa78287bd521cdfb7aa108d86c05"  },

  { weight:  2, height: 9 , length:15,  width: 8, name: "Mirror Forget Me Not Scarf", price: 12000, user_id: 5, description: "Awash in blooms of every color and trimmed with graphic details, this scarf of pure silk adds a touch of opulent indulgence to any ensemble.", stock:20, photo_url: "http://i01.i.aliimg.com/wsphoto/v0/2039859167_1/Silk-language-lotus-authentic-women-s-short-winter-days-to-be-warm-wool-long-scarf-shawl.jpg_350x350.jpg"   },

  { weight: 4 , height:  8, length:15,  width: 9, name: "Belted Drape Front Coat", price: 24500, user_id: 1, description: "A shoulder-spanning collar caps off the chic and easy style of a belt-wrapped coat with a clean, minimalist look.", stock:20, photo_url: "http://gloimg.dresslily.com/L/2015/201510/goods-img/1444938150130-P-3261312.jpg?a=6"  },

  { weight: 1 , height: 5 , length:16,  width: 4, name: "Bonnie Ocelot Archive Coat", price: 82000, user_id: 2, description: "Roomy patch pockets and a ballchain locker loop with a miniature hangtag charm add a touch of practicality to its dramatic silhouette. 100% printed goat fur with leather trim. 100% rayon lining", stock:20, photo_url: "https://s-media-cache-ak0.pinimg.com/736x/29/17/5c/29175c6ad4730ee3f58a3f5c474993bb.jpg" },

  { weight:  1, height: 22 , length:16,  width: 8, name: "'Orbit' Leather Moto Jacket", price: 45000, user_id: 3, description: "Clean trapunto stitching at the sleeves and exposed zip cuffs add to the cool, moto-inspired vibe of a cropped, asymmetrical jacket fashioned from washed black leather for an authentically worn finish.", stock:20, photo_url: " https://s-media-cache-ak0.pinimg.com/736x/a8/6a/e4/a86ae43b879061136b75bc670a0ef83c.jpg" },

  { weight:  0.5, height: 22 , length:16,  width: 33, name: "Floral Lace Crop Sweater", price: 12900, user_id: 3, description: "Slender straps, skin-baring cutaway shoulders and an abbreviated hem put a flirtatious twist on a pretty white tank sweetened with an overlay of floral lace.", stock:20, photo_url: " https://www.bauhaus.com.hk/image/cache/data/products/501216B598293201-350x350.jpg" },

  { weight:  0.3, height:  21, length:16,  width: 40, name: "Retro 1950's Polka Dot Cat Eye Fashion Sunglasses", price: 15900 , user_id: 4, description: "A distinct mod version of 50s-inspired cat eye sunglasses with high pointed corners and adorable polka dots. You'll find they can work with many outfits, from the very modern to the utterly vintage. Made with an acetate based frame, metal hinges and gradient polycarbonate UV protected lenses.", stock:20, photo_url: "  https://ledchristmaslighting.com/images/FM73252.jpg"},
]
